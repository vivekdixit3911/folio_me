...
import 'package:viv/data/model/activity.dart';
import 'package:viv/data/model/certificate.dart';
import 'package:viv/data/model/experience.dart';
import 'package:viv/data/model/project_info.dart';
import 'package:viv/data/model/quote.dart';
import 'package:viv/data/model/route_model.dart';
import 'package:viv/data/model/showcase_project.dart';
import 'package:viv/data/model/social_media.dart';
import 'package:viv/presentation/configs/constant_assets.dart';
import 'package:viv/presentation/configs/constant_colors.dart';
import 'package:viv/presentation/configs/constant_icons.dart';
import 'package:viv/presentation/configs/constant_sizes.dart';
import 'package:viv/presentation/route/routes.dart';
...
const String ksWorkEmail = "vivekdixit48313@gmail.com";
const String ksWorkPhone = "+91 9129999362";
...
const String ksCC = "©️ 2024 Vivek Kr. Dixit";
...
const String ksBriefAboutMe =
    "Hi! I'm a Front-end Software Engineer who is passionate about emerging Technologies and AI. I have fairly  amount of experience in developing high quality applications.";
const String ksMyLife =
    "I'm a 1 year student from the AKTU, Lucknow, INDIA. Pursuing.................................";
...
const String ksCoffee = "CHAI";
const String ksReading = "Reading";
const String ksMusic = "90's,20's Music";
const String ksMusicMobile = "90's,20's\nMusic";
...
final List<Activity> ksActivityList = [
  ...
  Activity(
    title: ksActivities,
    name:
        "Participated in HackIndia at ABES EC College.",
    icon: kiActivity,
    details:
        "This is a two-days Exchange Program with C#corner ( 2-weeks in ABES and Learnt data analytics, design thinking and co-operation skills and applied them on the Encryption Project",
  ),
  Activity(
    name:
        "",
...
final List<Experience> ksExperiences = [
  ...
  Experience(
    ...
    responsibilities: [
      ...
      "Worked closely with senior mobile developer and backend developer to develop  Dental Clinic System mobile app",
      "Worked on car service management system mobile app",
      "Architected and implemented small projects such as lottery prediction app using AI backend using python",
...
const String ksFacebookLink = 'https://www.facebook.com/Regikilll';
const String ksGithubLink = 'https://github.com/vivekdixit3911';
const String ksLinkedInLink = 'https://www.linkedin.com/in/vivek-dixit-790035202/';
// const String ksMediumLink = 'https://yelwino.medium.com/';
const String ksStackoverflowLink =
    'https://stackoverflow.com/users/25302230/vivek-kr-dixit';
const String ksDiscordLink = 'https://discordapp.com/users/.vivekdixit';
...
const String _ME = 'Vivek kr. Dixit';
...
final List<ShowcaseProject> ksShowcaseProjects = [
  ShowcaseProject(
    title: 'Chat APP -Encrypted',
    image: kaPulseX,
    shortDescription:
        "Chat-APP is a state management  Flutter projects.",
    description: """
        Chat-APP is the  Flutter project. It has five features:
          - state management
          - Real-time Messaging
    ...
    link: ProjectInfo(
      ...
      isLink: true,
      contents: [
        "https://github.com/vivekdixit3911/ChatApp.git",
      ],
    ),
    heroTag: 'pulse-x',
    tags: ProjectInfo(
  ...
  ShowcaseProject(
    title: 'I NEWS 60 words ',
    image: kaNotee,
    shortDescription: "Notee is a personal NEWS app built with Flutter",
    description: """
        Notee is a personal NEWS app that includes four parts :
         - Headlines: Instant access to top news stories worldwide.
- Customization: Tailor your news feed to your interests.
...
- Bookmarking: Save articles for later reading.
    ...
    link: ProjectInfo(
        ...
        isLink: true,
        contents: [
          "https://github.com/vivekdixit3911/Inews_60wordsnews.git",
        ]),
    heroTag: 'notee',
    tags: ProjectInfo(
      icon: kiTag,
  ...
  ShowcaseProject(
    ...
    description: """
        ...
        1. Input Fields: Supports metric (cm, kg) and imperial (feet/inches, pounds) units.
        2. Real-Time Calculation: Instantly displays BMI value.
        3. Category Display: Shows weight status (underweight, normal, overweight, obese) based on BMI.
        4. Health Tips: Offers advice based on BMI category.
        5. Visual Representation: Graphically represents the BMI scale for easy understanding.
        """,
    link: ProjectInfo(
      icon: kiLink,
      label: "Project Links",
      isLink: true,
      contents: [
        "https://github.com/vivekdixit3911/bmicalculator.git",
      ],
    ),
